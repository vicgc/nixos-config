rec {
  ...
  lightGray    = "#a6b3cc"; lightestGray = "#cbe3e7";
  white        = "#a6b3cc"; lightWhite   = "#cbe3e7";
  blue         = "#65b2ff"; lightBlue    = "#91ddff";
  cyan         = "#63f2f1"; lightCyan    = "#aaffe4";
  green        = "#62d196"; lightGreen   = "#95ffa4";
